...
const en = {
  ...
  'about.research.eyebrow': 'Research & Outcomes',
  'about.research.title': 'Ten days of practice, unfolding along the way',
  'about.research.body':
    'From daily field notes and cultural and ecological research to a plant guide, final reflection and field film, this growing archive gathers what we observed and learned along the way.',
  'about.research.log1.range': 'Day 1–4',
  'about.research.log1.title': 'Field Journal Day 1–4',
  'about.research.log2.range': 'Day 5–7',
  'about.research.log2.title': 'Field Journal Day 5–7',
  'about.research.log3.range': 'Day 8–10',
  'about.research.log3.title': 'Field Journal Day 8–10',
  'about.research.log4.range': 'Field Research',
  'about.research.log4.title': 'Cultural Research: When the Train Turns',
  'about.research.log5.range': 'Field Research',
  'about.research.log5.title': 'Ecological Research: What Is Happening at the Yangtze’s Southern Source?',
  'about.research.log6.range': 'Field Guide',
  'about.research.log6.title': 'Plant Guide',
  'about.research.log7.range': 'Reflection',
  'about.research.log7.title': 'Expedition Summary: Tracing Water, Grasslands and Pastoral Life',
  'about.research.log8.range': 'Field Film',
  'about.research.log8.title': 'VLOG',
  ...
  'stats.body':
    'A scientific view across every branch of life — diversity, species catalogs, and the people who document it.',
  ...
  'stats.catalog.eyebrow': 'Field Catalog',
  'stats.catalog.title': 'Qinghai Species Catalog',
  'stats.catalog.desc': 'Animal and plant records compiled during our Qinghai field practice, organized for browsing by taxonomy or searching by Chinese and scientific name.',
  'stats.catalog.type': 'Catalog type',
  'stats.catalog.animals': 'Animals',
  'stats.catalog.plants': 'Plants',
  'stats.catalog.search': 'Search common or scientific name',
  'stats.catalog.order': 'Order',
  'stats.catalog.family': 'Family',
  'stats.catalog.genus': 'Genus',
  'stats.catalog.all': 'All {category}',
  'stats.catalog.results': '{count} records',
  'stats.catalog.source': 'Compiled from the team’s source catalogs',
  'stats.catalog.number': 'No.',
  'stats.catalog.commonName': 'Chinese name',
  'stats.catalog.scientificName': 'Scientific name',
  'stats.catalog.classification': 'Classification',
  'stats.catalog.namePending': 'Name pending review',
  'stats.catalog.scientificPending': 'Scientific name pending review',
  'stats.catalog.noResults': 'No species match the current filters.',
  'stats.catalog.loadMore': 'Show {count} more',
