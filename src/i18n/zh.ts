...
const zh = {
  ...
  'about.research.eyebrow': '调研与成果',
  'about.research.title': '十天，一路生长的实践记录',
  'about.research.body':
    '从每日行程到人文与生态调研，再到植物图鉴、实践总结与影像记录，我们把沿途的观察与思考整理成一组持续生长的实践档案。',
  'about.research.log1.range': 'Day 1–4',
  'about.research.log1.title': '实践日志 Day 1~4',
  'about.research.log2.range': 'Day 5–7',
  'about.research.log2.title': '实践日志 Day 5~7',
  'about.research.log3.range': 'Day 8–10',
  'about.research.log3.title': '实践日志 Day 8~10',
  'about.research.log4.range': '专题调研',
  'about.research.log4.title': '人文调研：火车转弯时',
  'about.research.log5.range': '专题调研',
  'about.research.log5.title': '生态调研：长江南源正在发生什么？',
  'about.research.log6.range': '风物志',
  'about.research.log6.title': '植物图鉴',
  'about.research.log7.range': '实践回望',
  'about.research.log7.title': '实践总结：溯水问草，访牧寻源',
  'about.research.log8.range': '影像记录',
  ...
  'stats.body':
    '跨越每一个生命分支的科学视角——多样性、物种名录，以及记录它们的人。',
  ...
  'stats.catalog.eyebrow': '实践名录',
  'stats.catalog.title': '青海物种名录',
  'stats.catalog.desc': '团队在青海实践期间整理的动物与植物目录，可按分类浏览或通过中文名、拉丁学名检索。',
  'stats.catalog.type': '名录类型',
  'stats.catalog.animals': '动物',
  'stats.catalog.plants': '植物',
  'stats.catalog.search': '搜索中文名或拉丁学名',
  'stats.catalog.order': '目',
  'stats.catalog.family': '科',
  'stats.catalog.genus': '属',
  'stats.catalog.all': '全部{category}',
  'stats.catalog.results': '共 {count} 条记录',
  'stats.catalog.source': '依据团队原始名录整理',
  'stats.catalog.number': '序号',
  'stats.catalog.commonName': '中文名',
  'stats.catalog.scientificName': '拉丁学名',
  'stats.catalog.classification': '分类',
  'stats.catalog.namePending': '名称待核对',
  'stats.catalog.scientificPending': '学名待核对',
  'stats.catalog.noResults': '没有符合当前条件的物种。',
  'stats.catalog.loadMore': '再显示 {count} 条',
